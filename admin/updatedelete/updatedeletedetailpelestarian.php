<?php 
  ...
  if(isset($_POST['Simpan'])) {
    ...
    $karyabudaya = $_GET["kdkaryabudaya"];
      ...
      mysqli_query($connection, "UPDATE detil_pelestarian SET kd_pelestarian = '$kdpelestarianedit', kd_karyabudaya = '$kdkaryabudayaedit', tgl_pelestarian = '$tglpelestarian' WHERE kd_karyabudaya = '$karyabudaya' AND kd_pelestarian = '$pelestarian'");

      if(!mysqli_query($connection, "UPDATE detil_pelestarian SET kd_karyabudaya = '$kdkaryabudayaedit', kd_pelestarian = '$kdpelestarianedit', tgl_pelestarian = '$tglpelestarian' WHERE kd_karyabudaya = '$karyabudaya' AND kd_pelestarian = '$pelestarian'")) {
